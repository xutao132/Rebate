...
public class UsableRebateActivity extends AppCompatActivity{
    @BindView(R.id.my_webView) WebView webView;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        my_top_title.setText("使用余额");
        WebSettings webSettings = webView.getSettings();
        webSettings.setJavaScriptEnabled(true);
        webView.loadUrl(Constants.INFO_KEYONG_FANLI);
